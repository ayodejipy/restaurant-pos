...
<template>
    <div class="max-w-7xl mx-auto pt-14">
        <button class="bg-black text-white rounded-sm px-4 py-2" @click="toggleModal">
            Toggle modal
        </button>
        <AtomBaseModal :is-open="open" size="lg" rounded="2xl" @close="toggleModal">
            <div class="mt-2">
        ...
        <div class="max-w-lg">
            <div class="relative w-48 px-3 py-2.5 border border-gray-800">
                <AtomTheLink
                    url="/"
                    left-icon="material-symbols:home-rounded"
                    class="text-gray-700 font-normal hover:bg-gray-100"
                >
                    Homepage
                </AtomTheLink>
                <AtomTheLink
                    ...
                    class="text-gray-700 font-normal hover:bg-blue-100 hover:text-blue-500"
                >
                    Settings
                </AtomTheLink>
                <DropdownMenu
            ...
            <div class="flex gap-10">
                <AtomTheCard v-for="n in 3" :key="n" class="border bg-white" shadow="lg">
                    <div class="flex flex-col items-center justify-center p-6">
                        <div
                            class="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 mb-2"
                        >
        ...
        <div class="max-w-6xl bg-gray-100 p-3">
            ...
            <AtomTheAvatar
                size="lg"
                name="Ayodeji Jegede"
                url="https://wallpaper.dog/large/5568021.jpg"
            />
            <AtomTheAvatar
                size="sm"
