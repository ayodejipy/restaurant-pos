...
<template>
    <AtomTheCard
        rounded="xl"
        shadow="lg"
        :class="[backgroundColor, 'p-4 min-w-[16rem] max-w-full']"
    >
            ...
            <div class="flex-1 flex flex-col justify-between">
                <div>
                    ...
                    <p
                        ...
                        class="text-gray-400 text-xs mt-2 leading-normal truncate-text"
                    >
                        {{ menu.description }}
                    </p>
                </div>
                <span
                    class="inline-block mt-6 text-xs text-gray-400"
                    aria-label="available and sold items"
                    >{{ menu.available }} Available
                    <span class="font-semibold text-sm">&bull;</span> {{ menu.sold }} Sold</span
                >
            </div>
        </div>
        <div class="mt-6 flex justify-between">
            <h5
                ...
                class="relative text-gray-800 text-2xl font-bold first-letter:border first-letter:border-gray-400 first-letter:font-medium first-letter:text-sm first-letter:block first-letter:absolute"
            >
