            ...
            <div class="flex-1 flex flex-col justify-between">
                ...
                <div class="mt-6 flex items-center justify-between">
                    <div class="flex gap-3">
                        <AtomTheButton
                            intent="default"
                            class="bg-gray-200 text-gray-800 w-8 h-8 rounded-full"
                            :disabled="item.quantity == 0"
                            @click="decreaseOrderQuantity(item)"
                        >
                        ...
                        <AtomTheButton
                            ...
                            @click="increaseOrderQuantity(item)"
                        >
                            <Icon name="ic:baseline-plus" />
                        </AtomTheButton>
                    </div>
                    <p aria-label="meal price" class="text-gray-800 text-sm font-medium">
